...
describe("Condi duration calculations", () => {
    ...
    describe("minimizeDuration", () => {
        it("returns correct duration for simple", () =>
            assert.equal(minimizeDuration(1_000, 33.0), 32.01));
        it("returns correct duration for base with fraction", () =>
            assert.equal(minimizeDuration(1_200, 33.0), 30.01));
        it("returns correct duration for large", () =>
            assert.equal(minimizeDuration(100_000, 99.61), 99.61));
    });

    describe("nextHigherDuration", () => {
        it("returns correct duration for simple", () =>
            assert.equal(nextHigherDuration(1_000, 33.0), 36.01));
        it("returns correct duration for base with fraction", () =>
            assert.equal(nextHigherDuration(1_200, 33.0), 33.34));
        it("returns correct duration for large", () =>
            assert.equal(nextHigherDuration(100_000, 99.61), 99.65));
